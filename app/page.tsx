    ...
    <main className="bg-[#FBF6EE] text-[#3B342B]">
      ...
      <section className="max-w-6xl mx-auto px-6 py-16 bg-[#EAF2FB] border-t border-[#D6E3F3]">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-white rounded-2xl p-8 shadow-[0_6px_24px_rgba(60,90,130,0.08)] border border-[#D6E3F3]">
            <p className="text-[#4F6B85]">
              Kirby embeds or screenshots can go here next.
            </p>
          </div>

          <div className="bg-white rounded-2xl p-8 shadow-[0_6px_24px_rgba(60,90,130,0.08)] border border-[#D6E3F3]">
            <p className="text-[#4F6B85]">
              Add a second Kirby post, screenshot, or campaign example here.
            </p>
          </div>
        </div>
      </section>
